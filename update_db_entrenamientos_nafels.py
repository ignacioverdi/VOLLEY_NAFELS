...
def parse_dvw_both(fpath, temporada):
    ...
    for team, pfx, section in [(home,'*','[3PLAYERS-H]'),(away,'a','[3PLAYERS-V]')]:
        ...
        team = 'ENTRENAMIENTO'  # consolidar ambos lados en un solo equipo
...
if __name__ == '__main__':
    ...
    # Step 5: stats_entrenamiento.js (datos para el selector)
    print("\n5. Building stats_entrenamiento.js...")
    build_stats_table(players, teams, os.path.join(args.output_dir,'stats_entrenamiento.html'))

    print(f"\n{'='*60}")
    print(f"\u2713 LISTO — {len(games_log)} entrenamientos en la base")
    print(f"  Subir a GitHub: liga_data_entrenamientos.js, stats_entrenamiento.js")
    print(f"{'='*60}\n")
