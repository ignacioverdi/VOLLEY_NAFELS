...
### NÄFELS (repo VOLLEY_NAFELS)
- `camara_NAFELS.html`      → subir como  **camara.html**
- `video_delay_NAFELS.js`   → subir como  **video_delay.js**
- `panel_voley_NAFELS.html` → subir como  **panel_voley.html**  (ya trae el botón 📹 Video)

### CASLA (repo Voley-Stats)
- `camara_CASLA.html`       → subir como  **camara.html**
- `video_delay_CASLA.js`    → subir como  **video_delay.js**
- `panel_voley_CASLA.html`  → subir como  **panel_voley.html**
...
1. **En el celular** (el que apunta a la cancha, en trípode):
   - Abrí `volley-nafels.vercel.app/camara.html`
