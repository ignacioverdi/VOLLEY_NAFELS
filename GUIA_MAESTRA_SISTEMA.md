# 📖 GUÍA MAESTRA DEL SISTEMA — Volley Näfels
...
- **Datos:** `plantel_nafels.js` (el plantel maestro). **Correr antes:** NADA — se edita a mano cuando cambia el plantel.
...
- **Datos:** `datos_entrenamientos.js`. **Correr antes:** `correr_entrenamientos_nafels.bat`.
...
| Stats de entrenamientos | `correr_entrenamientos_nafels.bat` | Sí |
